						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card" style="">
								<div class="card-body" style="">
									<%
										String cc_code = "", cc_name = "";
											if (request.getParameter("cc_code_name") != null) {
												cc_code = request.getParameter("cc_code_name").split("~")[0];
												cc_name = request.getParameter("cc_code_name").split("~")[1];
											}
									%>

									<h5 class="card-title" align="left">
										<%=cc_name%>
										Collecting Center Target for year
										<%=year%></h5>
									<form method="post" action="SaveCCTarget" id="tar-form">
											...
											<table class="table table-hover table-striped" style="">
												...
												<%
													String month_arr[] = {"January", "February", "March", "April", "May", "June", "July", "August",
														...
														al = Query.getCCYearTargetUnit(mc, year, cc_code);
												...
												<thead>
													<tr>
														...
														<th align="center" style="text-align: center;">Count</th>
													</tr>
												</thead>
												<tbody>
													<%
														for (int j = 1; j <= month_arr.length; j++) {
													%>
													<tr>
														<td>
															<div class="input-group">
														...
														<td align="center">
															<div class="input-group">
																<input type="text" class="form-control" name="a_<%=j%>"
																	onclick="select()" value="<%=al.get(j - 1)[2]%>"
																	title="<%=month_arr[j - 1]%>"
																	style="font-weight: bold; text-align: right; width: 120px"
																	aria-label="Amount (to the nearest rupee)">
															</div>
														</td>
														<td align="center">
															<div class="input-group">
																<input type="text" class="form-control" name="c_<%=j%>"
																	onclick="select()" value="<%=al.get(j - 1)[3]%>"
																	title="<%=month_arr[j - 1]%>"
																	style="font-weight: bold; text-align: right; width: 80px"
																	aria-label="Count">
															</div>
														</td>
													</tr>
