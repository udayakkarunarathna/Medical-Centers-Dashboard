					...
					<div class="row">
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-primary text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Sales</h4>

									<h2 class="font-weight-normal mb-4">$ 15,00000.00</h2>
						...
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-info text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Orders</h4>

									<h2 class="font-weight-normal mb-4">45633456</h2>
						...
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-warning text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Patient Count</h4>

									<h2 class="font-weight-normal mb-4">955741235</h2>
					...
					<div align="center"
						...
						<span
							...
							© 2018 <a href="http://www.nawaloka.com/" target="_blank">Nawaloka
								Hospitals PLC</a>. All rights reserved.
						</span>
					</div>
				</footer>
				<!-- partial -->
