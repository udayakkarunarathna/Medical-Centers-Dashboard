...
<title>Dashboard | <%=session.getAttribute("title")%></title>
<!-- plugins:css -->
<link rel="stylesheet"
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item dropdown"><a
						...
						href="#" data-toggle="dropdown" aria-expanded="false"> <img
							...
							class="d-none d-lg-inline">Admin</span>
					</a>
					...
					<div class="sidebar-progress">
						...
						<div class="progress progress-sm">
							<div class="progress-bar bg-gradient-success" role="progressbar"
								style="width: 1000%" aria-valuenow="10" aria-valuemin="0"
					...
					<div class="row">
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-secondary text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Achievement</h4>

									<h2 class="font-weight-normal mb-4">
										Rs.
										<%=df.format(da)%></h2>

									<p class="card-text">Incresed by 20%</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-primary text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Target</h4>

									<h2 class="font-weight-normal mb-4">
										Rs.
										<%=df.format(dt)%></h2>

									<p class="card-text">Incresed by 0%</p>
								</div>
							</div>
						</div>
						<%
						...
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-success text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Success</h4>
						...
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-warning text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Unsuccess</h4>

									<h2 class="font-weight-normal mb-4"><%=da - dt%></h2>

									<p class="card-text">Decreased by 5%</p>
								</div>
							</div>
						</div>
						<%
						...
						<div class="col-md-3 stretch-card grid-margin">
							<div class="card bg-gradient-danger text-white">
								<div class="card-body">
									<h4 class="font-weight-normal mb-2">Weekly Patient Count</h4>

									<h2 class="font-weight-normal mb-4"><%=dhc%></h2>
									...
									<div class="d-flex mt-5 align-items-top">
										...
										<div class="mb-0 flex-grow">
											...
											<p>This is amazing! We have moved to a brand new office
												in New Hampshire with a lot more space. We will miss our old
												office but we are very excited about our new space.</p>
										</div>
										<div class="ml-auto">
