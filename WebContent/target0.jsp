											...
											<table class="table table-hover table-striped" border="1">
												<thead>
													<tr>
														...
														<th rowspan="2" valign="middle"
															style="vertical-align: middle;">Month</th>
												...
												<tbody>
													<%
														String month_arr[] = {"January", "February", "March", "April", "May", "June", "July", "August",
															...
															al = Query.getYearTarget(mc, year, "amount");
													...
													<tr>
														...
														<td style="vertical-align: middle;"><%=month_arr[i - 1]%><input
															type="hidden" name="m_<%=i%>" value="<%=i%>" /></td>
														<td align="center">
															<div class="input-group">
