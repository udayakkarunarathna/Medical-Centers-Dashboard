...
<%
	...
	} else if (session.getAttribute("mc") != null) {
		mc = Integer.parseInt((String) session.getAttribute("mc"));
	}

	//System.out.println("mc fd = " + mc);
					...
					<div class="form-group"
						...
						<div class="btn-group btn-group-sm" data-toggle="buttons" style="border: 0px">
							...
							<label
								...
								<%if (select_type1.equals("OPD")) {%> checked="checked" <%}%> />OPD&nbsp;&nbsp;</label>
							...
							<label
								class="btn btn-info <%if (select_type1.equals("CHANNEL")) {%> active <%}%>"
								for="channel" style="cursor: pointer;"><input
								type="radio" name="select_type1" id="channel" value="CHANNEL"
								<%if (select_type1.equals("CHANNEL")) {%> checked="checked"
								<%}%> />Channel&nbsp;&nbsp;</label> 
