...
<%
	...
	if (!select_type1.equals("CHANNEL")) {
		ph_target = Query.getTargetTransaction("PH", date_from, date_to, select_type1, select_type2,
		conn);
	...
	if (select_type2.equals("REV")) {
		...
		String ph_color = "", lab_color = "", sna_color = "", mp_color = "", channel_color = "";
		...
		if (channel_target < channel_income) {
			channel_color = "#64E572";
		} else {
			channel_color = "#F16868";
		}

		double ph_per = 0, lab_per = 0, sna_per = 0, mp_per = 0, channel_per = 0;
		;
	...
	$(function() {
		...
		var chart1 = new Highcharts.chart(
				'ph',
				{
					...
					colors: ['rgb(124, 181, 236)', '<%=ph_color%>'],
					title : {
						text : '<%=select_type1%> Target Vs Achievement - Pharmacy - Cash & Credit - Without Collecting Center'
					},
					subtitle : {
					...
					plotOptions : {
						column : {
							...
							dataLabels : {
								...
								x: 0,
				                y: 0,
								format : '<span style="font-size:22px; color:#f96868;">{point.per:.0f} {point.symbol}</span><br/><span style="font-size:12px"><%=currency1%> {point.y:,.0f}</span>'
							}
						}
					},
					"series" : [ {
	...
	,
		...
		var chart2 = new Highcharts.chart(
				'lab',
				{
					...
					colors: ['rgb(124, 181, 236)', '<%=lab_color%>'],
					title : {
						text : '<%=select_type1%> Target Vs Achievement - Lab - With Medical Packages Lab Tests - Without Collecting Center'
					},
					subtitle : {
						text : 'Between <b><u><%=date_from%></u></b> and <b><u><%=date_to%></u></b>'
					},
	...
	,
		...
		var chart4 = new Highcharts.chart(
				'sna',
				{
					...
					colors: ['rgb(124, 181, 236)', '<%=sna_color%>'],
					title : {
						text : '<%=select_type1%> Target Vs Achievement - Service Non Appointment - Without Collecting Center'
					},
					subtitle : {
						text : 'Between <b><u><%=date_from%></u></b> and <b><u><%=date_to%></u></b>'
					},
	...
	,
		...
		var chart5 = new Highcharts.chart(
				'chl',
				{
					...
					colors: ['rgb(124, 181, 236)', '<%=channel_color%>'],
					title : {
						text : '<%=select_type1%> Target Vs Achievement - Channel'
					},
					subtitle : {
						text : 'Between <b><u><%=date_from%></u></b> and <b><u><%=date_to%></u></b>'
					},
...
<%=df1.format(channel_target)%>
	,
						...
						"data" : [ {
							"color" : "<%=channel_color%>",
							"y" :
<%=df1.format(channel_income)%>
	,
							"per" :
<%=df1.format(channel_per)%>
	,
							"symbol" : '%'
						} ]
					} ]
			...
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					...
					<%
						///////////////////////// Modal - End
					%>
					<div class="row" <%if(select_type1.equals("CHANNEL")){ %> style="display: none;" <%} %>>
					...
					<div class="row">
						<!-- <div class="col-md-6 grid-margin stretch-card" style="display: none;">
							<div class="card">
								<div class="card-body">
						...
						<div class="col-md-6 grid-margin stretch-card" <%if(select_type1.equals("CHANNEL")){ %> style="display: none;" <%} %>>
							<div class="card">
								<div class="card-body">
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<div id="chl" style="width: 100%; height: 500px;"></div>
								</div>
							</div>
						</div>
					</div>
