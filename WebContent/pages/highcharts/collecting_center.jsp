		...
		var myChart = Highcharts
				.chart(
						'containerBar',
						{
							...
							title : {
								text : 'Target Vs Achievment - Collecting Center',
						        align: 'left'
							},
							subtitle : {
			...
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					...
					<jsp:include page="../../filter_date.jsp"><jsp:param
							value="collecting_center.jsp" name="action" /><jsp:param
							value="yes" name="cc" /><jsp:param value="yes" name="sub" /><jsp:param
