...
<%
	// System.out.println("Speciality Comparison...");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<%
	int mc = 0;
		...
		String speciality_id = "*", speciality_name = "*";
		if (request.getParameter("speciality") != null) {
			speciality_id = request.getParameter("speciality").split("~")[0];
			speciality_name = request.getParameter("speciality").split("~")[1];
		}
		...
		try {
			...
			if (date_selection.equals("date")) {
				...
				if (speciality_id.equals("*")) {
					/* ph_target = Query.getTargetTransaction("PH", date1, date1, select_type1, select_type2,
							conn);
					lab_target = Query.getTargetTransaction("LAB", date1, date1, select_type1, select_type2,
							conn);
					mp_target = Query.getTargetTransaction("MP", date1, date1, select_type1, select_type2,
							conn);
					sna_target = Query.getTargetTransaction("SNA", date1, date1, select_type1, select_type2,
							conn); */
					/*chl_target = Query.getTargetAmount("CHL", date1, date1, select_type1, conn);*/
				}
				ph_income1 = Query.PharmachyTransactionSpeciality(date1, date1, select_type1, select_type2,
						speciality_id, conn);
				lab_income1 = Query.LabTransactionSpeciality(date1, date1, select_type1, select_type2,
						speciality_id, conn);
				//mp_income1 = Query.MedicalPackagesTransactionSpeciality(date1, date1, select_type1,	select_type2, speciality_id, conn);
				sna_income1 = Query.SNATransactionSpeciality(date1, date1, select_type1, select_type2,
						speciality_id, conn);
				/*chl_income1 = Query.ChannelRevenueWC(date1, date1, select_type1, conn);*/

				ph_income2 = Query.PharmachyTransactionSpeciality(date2, date2, select_type1, select_type2,
						speciality_id, conn);
				lab_income2 = Query.LabTransactionSpeciality(date2, date2, select_type1, select_type2,
						speciality_id, conn);
				//mp_income2 = Query.MedicalPackagesTransactionSpeciality(date2, date2, select_type1, select_type2, speciality_id, conn);
				sna_income2 = Query.SNATransactionSpeciality(date2, date2, select_type1, select_type2,
						speciality_id, conn);
				/*
				...
				if (speciality_id.equals("*")) {
					/* ph_target = (Query.getTargetTransaction("PH", week1, week11, select_type1, select_type2,
							conn)
							+ Query.getTargetTransaction("PH", week2, week22, select_type1, select_type2, conn))
							/ 2;
					lab_target = (Query.getTargetTransaction("LAB", week1, week11, select_type1, select_type2,
							conn)
							+ Query.getTargetTransaction("LAB", week2, week22, select_type1, select_type2,
									conn))
							/ 2;
					mp_target = (Query.getTargetTransaction("MP", week1, week11, select_type1, select_type2,
							conn)
							+ Query.getTargetTransaction("MP", week2, week22, select_type1, select_type2, conn))
							/ 2;
					sna_target = (Query.getTargetTransaction("SNA", week1, week11, select_type1, select_type2,
							conn)
							+ Query.getTargetTransaction("SNA", week2, week22, select_type1, select_type2,
									conn))
							/ 2; */
				...
				ph_income1 = Query.PharmachyTransactionSpeciality(week1, week11, select_type1, select_type2,
						speciality_id, conn);
				lab_income1 = Query.LabTransactionSpeciality(week1, week11, select_type1, select_type2,
						speciality_id, conn);
				//mp_income1 = Query.MedicalPackagesTransactionSpeciality(week1, week11, select_type1, select_type2, speciality_id, conn);
				sna_income1 = Query.SNATransactionSpeciality(week1, week11, select_type1, select_type2,
						speciality_id, conn);
				//chl_income1 = Query.ChannelRevenueWC(week1, week11, select_type1, conn);

				ph_income2 = Query.PharmachyTransactionSpeciality(week2, week22, select_type1, select_type2,
						speciality_id, conn);
				lab_income2 = Query.LabTransactionSpeciality(week2, week22, select_type1, select_type2,
						speciality_id, conn);
				//mp_income2 = Query.MedicalPackagesTransactionSpeciality(week2, week22, select_type1, select_type2, speciality_id, conn);
				sna_income2 = Query.SNATransactionSpeciality(week2, week22, select_type1, select_type2,
						speciality_id, conn);
				...
				ph_income1 = Query.PharmachyTransactionSpeciality((month1 + "-01"),
						Query.getLastDate(month1, conn), select_type1, select_type2, speciality_id, conn);
				lab_income1 = Query.LabTransactionSpeciality((month1 + "-01"), Query.getLastDate(month1, conn),
						select_type1, select_type2, speciality_id, conn);
				//mp_income1 = Query.MedicalPackagesTransactionSpeciality((month1 + "-01"), Query.getLastDate(month1, conn), select_type1, select_type2, speciality_id, conn);
				sna_income1 = Query.SNATransactionSpeciality((month1 + "-01"), Query.getLastDate(month1, conn),
						select_type1, select_type2, speciality_id, conn);
				//chl_income1 = Query.ChannelRevenueWC((month1 + "-01"), Query.getLastDate(month1, conn), select_type1, select_type2,	mc);

				ph_income2 = Query.PharmachyTransactionSpeciality((month2 + "-01"),
						Query.getLastDate(month2, conn), select_type1, select_type2, speciality_id, conn);
				lab_income2 = Query.LabTransactionSpeciality((month2 + "-01"), Query.getLastDate(month2, conn),
						select_type1, select_type2, speciality_id, conn);
				//mp_income2 = Query.MedicalPackagesTransactionSpeciality((month2 + "-01"), Query.getLastDate(month2, conn), select_type1, select_type2, speciality_id, conn);
				sna_income2 = Query.SNATransactionSpeciality((month2 + "-01"), Query.getLastDate(month2, conn),
						select_type1, select_type2, speciality_id, conn);
				//chl_income2 = Query.ChannelRevenueWC((month2 + "-01"), Query.getLastDate(month2, conn), select_type1, select_type2,	speciality_id);
				...
				ph_income1 = Query.PharmachyTransactionSpeciality((year1 + "-01-01"), (year1 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				lab_income1 = Query.LabTransactionSpeciality((year1 + "-01-01"), (year1 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				//mp_income1 = Query.MedicalPackagesTransactionSpeciality((year1 + "-01-01"), (year1 + "-12-31"),	select_type1, select_type2, speciality_id, conn);
				sna_income1 = Query.SNATransactionSpeciality((year1 + "-01-01"), (year1 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				//chl_income1 = Query.ChannelRevenueWC((year1 + "-01-01"), (year1 + "-12-31"), select_type1, select_type2, speciality_id);

				ph_income2 = Query.PharmachyTransactionSpeciality((year2 + "-01-01"), (year2 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				lab_income2 = Query.LabTransactionSpeciality((year2 + "-01-01"), (year2 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				//mp_income2 = Query.MedicalPackagesTransactionSpeciality((year2 + "-01-01"), (year2 + "-12-31"),	select_type1, select_type2, speciality_id, conn);
				sna_income2 = Query.SNATransactionSpeciality((year2 + "-01-01"), (year2 + "-12-31"),
						select_type1, select_type2, speciality_id, conn);
				//chl_income2 = Query.ChannelRevenueWC((year2 + "-01-01"), (year2 + "-12-31"), select_type1, select_type2, speciality_id);
			...
			if (select_type1.equals("All")) {
				session.setAttribute("target_all",
						ph_target + lab_target + sna_target + mp_target + chl_target);
				session.setAttribute("revenue1",
						ph_income1 + lab_income1 + sna_income1 + mp_income1 + chl_income1);
				session.setAttribute("revenue2",
						ph_income2 + lab_income2 + sna_income2 + mp_income2 + chl_income1);
			}
		...
		var myChart = Highcharts
				.chart(
						'containerBar',
						{
							...
							colors: [null, null],
							title : {
								text : 'Speciality <%=heading1%> <%=heading2%> Comparison'
							},
							subtitle : {
								text : '<%=title_ex%> (<b><u><%=sub_title1%></u></b> and <b><u><%=sub_title2%></u></b>)<br/>Speciality : <%if (!speciality_name.equals("*")) {%><%=speciality_name%><%} else {%>All<%}%>'
							},
							xAxis : {
								//gridLineColor : 'white',
							...
							"series" : [ <%if (speciality_id.equals("*")) {%>
			...
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					...
					<%
						///////////////////////// Modal - Start
					%>
					<jsp:include page="../../filter_speciality.jsp"><jsp:param
							value="comparisonspeciality.jsp" name="action" /><jsp:param
