	...
	int mc = 0;
		...
		try {
			...
			if (date_selection.equals("date")) {
				...
				target = Query.getTargetTransaction("MP", date1, date1, select_type1, select_type2, conn);

				if (select_type2.equals("REV")) {
					income1 = Query.MediPackRevenueWC(date1, date1, select_type1, conn);
					income2 = Query.MediPackRevenueWC(date2, date2, select_type1, conn);
					al = Query.MPRevenueBreakdownWC(date1, date1, date2, date2, select_type1, "ASC", conn);
				} else if (select_type2.equals("TXN")) {
					income1 = Query.MediPackCountWC(date1, date1, select_type1, "All", conn);
					income2 = Query.MediPackCountWC(date2, date2, select_type1, "All", conn);
					al = Query.MPCountBreakdownWC(date1, date1, date2, date2, select_type1, "ASC", conn);
				}
				...
				target = (Query.getTargetTransaction("MP", week1, week11, select_type1, select_type2, conn)
						+ Query.getTargetTransaction("MP", week2, week22, select_type1, select_type2, conn))
						/ 2;

				if (select_type2.equals("REV")) {
					income1 = Query.MediPackRevenueWC(week1, week11, select_type1, conn);
					income2 = Query.MediPackRevenueWC(week2, week22, select_type1, conn);
					al = Query.MPRevenueBreakdownWC(week1, week11, week2, week22, select_type1, "ASC", conn);
				} else if (select_type2.equals("TXN")) {
					income1 = Query.MediPackCountWC(week1, week11, select_type1, "All", conn);
					income2 = Query.MediPackCountWC(week2, week22, select_type1, "All", conn);
					al = Query.MPCountBreakdownWC(week1, week11, week2, week22, select_type1, "ASC", conn);
				}
				...
				target = Query.getTargetTransaction("MP", (month1 + "-01"), Query.getLastDate(month2, conn),
						select_type1, select_type2, conn) / 2;

				if (select_type2.equals("REV")) {
					income1 = Query.MediPackRevenueWC((month1 + "-01"), Query.getLastDate(month1, conn), select_type1, conn);
					income2 = Query.MediPackRevenueWC((month2 + "-01"), Query.getLastDate(month2, conn), select_type1, conn);
					al = Query.MPRevenueBreakdownWC((month1 + "-01"), Query.getLastDate(month1, conn), (month2 + "-01"), Query.getLastDate(month2, conn), select_type1, "ASC", conn);
				} else if (select_type2.equals("TXN")) {
					income1 = Query.MediPackCountWC((month1 + "-01"), Query.getLastDate(month1, conn), select_type1, "All", conn);
					income2 = Query.MediPackCountWC((month2 + "-01"), Query.getLastDate(month2, conn), select_type1, "All", conn);
					al = Query.MPCountBreakdownWC((month1 + "-01"), Query.getLastDate(month1, conn), (month2 + "-01"), Query.getLastDate(month2, conn), select_type1, "ASC", conn);
				}
				...
				target = Query.getTargetTransaction("MP", (year1 + "-01-01"), (year2 + "-12-31"), select_type1,
						select_type2, conn) / 2;

				if (select_type2.equals("REV")) {
					income1 = Query.MediPackRevenueWC((year1 + "-01-01"), (year1 + "-12-31"), select_type1, conn);
					income2 = Query.MediPackRevenueWC((year2 + "-01-01"), (year2 + "-12-31"), select_type1, conn);
					al = Query.MPRevenueBreakdownWC((year1 + "-01-01"), (year1 + "-12-31"), (year2 + "-01-01"), (year2 + "-12-31"), select_type1, "ASC", conn);
				} else if (select_type2.equals("TXN")) {
					income1 = Query.MediPackCountWC((year1 + "-01-01"), (year1 + "-12-31"), select_type1, "All", conn);
					income2 = Query.MediPackCountWC((year2 + "-01-01"), (year2 + "-12-31"), select_type1, "All", conn);
					al = Query.MPCountBreakdownWC((year1 + "-01-01"), (year1 + "-12-31"), (year2 + "-01-01"), (year2 + "-12-31"), select_type1, "ASC", conn);
				}
		...
		Highcharts
				.chart(
						'containerBar',
						{
							...
							title : {
								text : '<%=select_type1%> <%=select_type2_S%> Comparison - Medical Packages'
							},
							subtitle : {
		...
		var chart2 = new Highcharts
				.chart(
						'containerBar1',
						{
							...
							title : {
								text : '<%=select_type1%> <%=select_type2_S%> Comparison - Medical Packages Breakdown'
							},
							subtitle : {
								text : '<%=title_ex%> <b><u><%=sub_title1%></u></b> and <b><u><%=sub_title2%></u></b>'
							},
			...
			<div class="row row-offcanvas row-offcanvas-right">
				...
				<div class="content-wrapper">
					...
					<jsp:include page="../../filter_all.jsp"><jsp:param
							value="comparison3.jsp" name="action" /><jsp:param
