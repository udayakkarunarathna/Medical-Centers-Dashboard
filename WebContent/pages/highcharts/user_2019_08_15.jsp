...
<%
	DecimalFormat df = new DecimalFormat("###,###.##");
		...
		String category[] = {"Pharmacy", "Lab", "Medical Package", "Service Non Appointment"};
		String category_color[] = {"rgb(144, 237, 125)", "rgb(247, 163, 92)", "rgb(124, 181, 236)",
				"rgb(231, 241, 104)"};
		...
		try {
			...
			String query = "SELECT DISTINCT UPPER(USER_ID) USER_ID FROM"
				...
				while (rs.next()) {
					...
					if (!select_type2.equals("Transactions")) {
						...
						if (ph_income + lab_income + mp_income + sna_income > 0)
							income_arraylist
									.add(new UserIncome(user_id, ph_income, lab_income, mp_income, sna_income));
					...
					if (!select_type2.equals("Revenue")) {
						...
						if (ph_count + lab_count + mp_count + sna_count > 0)
							count_arraylist
									.add(new UserIncome(user_id, ph_count, lab_count, mp_count, sna_count));
		...
		if (!select_type2.equals("Transactions")) {
			for (UserIncome str : income_arraylist) {
				...
				String[] arr = {str.getUserName(), Double.toString(str.getPhIncome()),
						Double.toString(str.getLabIncome()), Double.toString(str.getMpIncome()),
		...
		for (int i = 0; i < income_arraylist1.size(); i++) {
			// System.out.println(income_arraylist1.get(i)[0] + " , " + income_arraylist1.get(i)[1] + " , " + income_arraylist1.get(i)[2] + " , " + income_arraylist1.get(i)[3]);
		}
		for (int i = 0; i < count_arraylist1.size(); i++) {
			// System.out.println(count_arraylist1.get(i)[0] + " , " + count_arraylist1.get(i)[1] + " , " + count_arraylist1.get(i)[2] + " , " + count_arraylist1.get(i)[3]);
		}
%>
<!DOCTYPE html>
<html lang="en">
										...
										<table class="table" border="0">
											<thead>
												<tr>
													...
													<th></th>
													<th align="right" style="text-align: right;">Medical
														Package</th>
											...
											<tbody>
													...
													double tot_user_income = 0;
															...
															for (int i = 0; i < income_arraylist1.size(); i++) {
																tot_user_income = tot_user_income + Double.parseDouble(income_arraylist1.get(i)[1])
																		...
																		+ Double.parseDouble(income_arraylist1.get(i)[4]);
															}
															...
															for (int i = 0; i < income_arraylist1.size(); i++) {
																...
																mp_tot = mp_tot + Double.parseDouble(income_arraylist1.get(i)[3]);
																ph_tot = ph_tot + Double.parseDouble(income_arraylist1.get(i)[1]);
																sna_tot = sna_tot + Double.parseDouble(income_arraylist1.get(i)[4]);
												...
												<tr>
													...
													<td align="right"><%=df.format(Double.parseDouble(income_arraylist1.get(i)[4]))%></td>
												...
												<tr>
													...
													<td align="right"><%=df.format(mp_tot)%></td>
										...
										<table class="table" border="0">
											...
											<tbody>
													...
													double tot_user_count = 0;
															...
															for (int i = 0; i < count_arraylist1.size(); i++) {
																tot_user_count = tot_user_count + Double.parseDouble(count_arraylist1.get(i)[1])
																		...
																		+ Double.parseDouble(count_arraylist1.get(i)[4]);
															}
															...
															for (int i = 0; i < count_arraylist1.size(); i++) {
																...
																mp_tot = mp_tot + Double.parseDouble(count_arraylist1.get(i)[3]);
																ph_tot = ph_tot + Double.parseDouble(count_arraylist1.get(i)[1]);
																sna_tot = sna_tot + Double.parseDouble(count_arraylist1.get(i)[4]);
												...
												<tr>
													...
													<td align="right"><%=df.format(Double.parseDouble(count_arraylist1.get(i)[4]))%></td>
